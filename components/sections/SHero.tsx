    ...
    return (
        <section 
            ...
            className={classNames(
                "bg-clr-bg-secondary",
                // "pt-4",
                "md:pt-28 md:bg-transparent md:pb-32",
        ...
        >
            ...
            >
                ...
                <div
                    className={classNames(
                        "md:rounded-3xl flex flex-col",
                        "py-16", //! Mobile
                        "md:px-6 md:py-28 md:place-items-center",
                        "md:bg-gradient-to-r from-clr-bg-secondary to-clr-bg-secondary/90",
                        "relative overflow-hidden group/blob",
                        "transition duration-300 ease-linear md:hover:drop-shadow-lg shadow-clr-bg-secondary"
                    )}
                >

                    {/* Blobs SVG */}
                    <Blob 
                        className="hidden lg:block absolute w-4/12 h-4/6 -top-[10%] -left-[15%] rotate-12 group-hover/blob:translate-x-20 transition duration-300 ease-linear" 
                        src="https://res.cloudinary.com/dltslq5fh/image/upload/v1670445356/blobs/cpezyxik2nqkjhhqf2fr.svg"
                    />
                    <Blob 
                        className="hidden lg:block absolute w-4/12 h-4/6 -bottom-[18%] -right-[15%] -rotate-6 group-hover/blob:-translate-x-20 transition duration-300 ease-linear"
                        src="https://res.cloudinary.com/dltslq5fh/image/upload/v1670445356/blobs/cpezyxik2nqkjhhqf2fr.svg" 
                    />
